    ...
    <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-3 mb-8">
          ...
          <p className="text-xs text-slate-400 font-semibold">Enter details to access your 3D subscription vault</p>
        </div>

        {/* Form */}
        <form onSubmit={handleSubmit} className="space-y-4">
          {error && (
            <div className="p-3 bg-red-950/20 border border-red-500/20 rounded-xl text-red-400 text-xs flex items-center gap-2 animate-shake">
